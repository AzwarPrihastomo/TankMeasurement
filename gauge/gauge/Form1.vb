...
Public Class Form1
  ...
  Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
    ...
    If ((gotLevel Or levelDammage) And (gotPress Or presDammage) And (gotTemp Or tempDammage)) Then
      ...
      If gotPress Then
        gotPress = False
        gaugePressure.Value = toKpa(Convert.ToDouble(dataPress))
  ...
  Private Sub TablesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TablesToolStripMenuItem.Click
    ...
    End If
  End Sub
  Private Sub reset_status()
    SystemStatus.Text = "IDLE"
    SystemStatus.BackColor = Color.Green
    LevelStatus.Text = "Tank Level Status"
    TempStatus.Text = "Tank Temp Status"
    PressStatus.Text = "Tank Press Status"
    LevelStatus.ForeColor = Color.Black
    TempStatus.ForeColor = Color.Black
    PressStatus.ForeColor = Color.Black
  End Sub
